 ...
 */
public class WildcardUserManagerFactory implements UserManagerFactory {
    ...
    public UserManager createUserManager() {
        if (userDataURL != null) {
            return new WildcardUserManager(passwordEncryptor, userDataURL,
                    adminName);
        } else {

            return new WildcardUserManager(passwordEncryptor, userDataFile,
                    adminName);
        }
    }
